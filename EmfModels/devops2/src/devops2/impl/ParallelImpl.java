 ...
 * </p>
 * <ul>
 *   <li>{@link devops2.impl.ParallelImpl#getJob <em>Job</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParallelImpl extends MinimalEObjectImpl.Container implements Parallel {
	...
	protected EClass eStaticClass() {
		return Devops2Package.Literals.PARALLEL;
	}
	...
	public EList<Job> getJob() {
		if (job == null) {
			job = new EObjectContainmentEList<Job>(Job.class, this, Devops2Package.PARALLEL__JOB);
		}
		return job;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Devops2Package.PARALLEL__JOB:
