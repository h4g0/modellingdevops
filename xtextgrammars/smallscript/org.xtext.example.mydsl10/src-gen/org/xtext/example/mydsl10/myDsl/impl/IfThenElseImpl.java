 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl10.myDsl.impl.IfThenElseImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.xtext.example.mydsl10.myDsl.impl.IfThenElseImpl#getIf <em>If</em>}</li>
 *   <li>{@link org.xtext.example.mydsl10.myDsl.impl.IfThenElseImpl#getElse <em>Else</em>}</li>
 *   <li>{@link org.xtext.example.mydsl10.myDsl.impl.IfThenElseImpl#getIfelse <em>Ifelse</em>}</li>
 *   <li>{@link org.xtext.example.mydsl10.myDsl.impl.IfThenElseImpl#getElseif <em>Elseif</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfThenElseImpl extends MinimalEObjectImpl.Container implements IfThenElse
{
  ...
  public void setCondition(String newCondition)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.IF_THEN_ELSE__CONDITION, oldCondition, condition));
  }
  ...
  public EList<Command> getIf()
  {
    if (if_ == null)
    {
      if_ = new EObjectContainmentEList<Command>(Command.class, this, MyDslPackage.IF_THEN_ELSE__IF);
    }
    return if_;
  }
  ...
  public EList<Command> getElse()
  {
    if (else_ == null)
    {
      else_ = new EObjectContainmentEList<Command>(Command.class, this, MyDslPackage.IF_THEN_ELSE__ELSE);
    }
    return else_;
  }
  ...
  public EList<IfThenElse> getIfelse()
  {
    if (ifelse == null)
    {
      ifelse = new EObjectContainmentEList<IfThenElse>(IfThenElse.class, this, MyDslPackage.IF_THEN_ELSE__IFELSE);
    }
    return ifelse;
  }
  ...
  public EList<IfThenElse> getElseif()
  {
    if (elseif == null)
    {
      elseif = new EObjectContainmentEList<IfThenElse>(IfThenElse.class, this, MyDslPackage.IF_THEN_ELSE__ELSEIF);
    }
    return elseif;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.IF_THEN_ELSE__CONDITION:
        return getCondition();
      case MyDslPackage.IF_THEN_ELSE__IF:
        return getIf();
      case MyDslPackage.IF_THEN_ELSE__ELSE:
