...
public class Devops2PackageImpl extends EPackageImpl implements Devops2Package {
	 ...
	 * @generated
	 */
	public EReference getJob_Job_parameter() {
	 ...
	 * @generated
	 */
	public EReference getCommand_Envirnoment_c() {
	 ...
	 * @generated
	 */
	public EReference getIfThenElse_Environment_if() {
		return (EReference)ifThenElseEClass.getEStructuralFeatures().get(5);
	}
	...
	public void createPackageContents() {
		...
		createEReference(jobEClass, JOB__JOB_PARAMETER);
		...
		createEReference(commandEClass, COMMAND__ENVIRNOMENT_C);
		...
		createEReference(ifThenElseEClass, IF_THEN_ELSE__ENVIRONMENT_IF);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getJob_Job_parameter(), this.getEnvironment(), null, "job_parameter", null, 0, -1, Job.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCommand_Envirnoment_c(), this.getEnvironment(), null, "envirnoment_c", null, 0, -1, Command.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIfThenElse_Environment_if(), this.getEnvironment(), null, "environment_if", null, 0, -1, IfThenElse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
